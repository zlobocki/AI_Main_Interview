...
| 2026-02-23 | Fixed "invalid username or password" after re-setup: added `/api/setup/prefill` endpoint returning current DB env vars; setup wizard now pre-fills DB fields from env vars to prevent DB mismatch (admin user inserted into wrong DB) |
